...
module.exports = {
  ...
  provideFolding () {
    return {
      ...
      isFoldableAtRow: ({row, editor}) => isFoldableAtRow(row, editor),
      getFoldableRangeContainingPoint: ({point, editor}) => getFoldableRangeContainingPoint(point, editor),
      getFoldableRangesAtIndentLevel: ({level, editor}) => getFoldableRangesAtIndentLevel(level, editor)
    };
  }
};
